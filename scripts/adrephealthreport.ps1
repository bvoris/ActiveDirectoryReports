...
$reportpath = "c:\inetpub\wwwroot\gen\adrephealthreport.html"  
$timeout = "120" 
...
<CENTER>
<Font size=5><B>AD Health Report</B></font></BR>
<Font size=4><B>AD Health Report</B></font></BR>
<Font size=3>$dated<BR />
<I>Purpose:</I> This report designed to run DCDiag.exe and report any problems in AD.<BR /><BR />
</CENTER></font><BR />
"@              

#Create the HTML and save it to a file
#$HTML = $Result | Select $Fields | ConvertTo-Html -Head $htmlhead  -PreContent $report
#$HTML | Out-File "C:\scripts\reports\ADHealthReport-$fileDate.html"